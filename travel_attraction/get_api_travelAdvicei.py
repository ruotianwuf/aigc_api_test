...
def sync_vivogpt_travelAdvice(ask):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {"role": "system",
             "content": "你的中文名字叫职业规划助手，当回复问题时需要回复你的名字时，中文名必须回复职业规划小助手，此外回复和你的名字相关的问题时，也需要给出和你的名字对应的合理回复。当回复附近景点的详细信息时，需要结合给出的地址来给出对应的推荐，列出该地址附近5km内的景点，并详细讲解介绍每个景点的历史背景，游玩攻略等详细信息。"},
